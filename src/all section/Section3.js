...
const Section3 = () => {
    return (
        <section style={{ color: 'white', backgroundColor: 'black', position: 'relative', display: 'flex' }}>
            <Container >
                <Box sx={{ minHeight: '700px', justifyContent: 'center', flexDirection: 'column', position: 'relative', margin: '0 auto' }}>
                    <Zoom>
