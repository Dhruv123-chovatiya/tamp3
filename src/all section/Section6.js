...
const Section6 = () => {
    ...
    return (
        <section style={{ color: 'white', backgroundColor: '#1a1a1a', position: 'relative', display: 'block' }}>
            <Container>
                <Box sx={{ minHeight: '586px', position: 'relative', margin: '0 auto', display: 'flex', flexDirection: 'column' }}>
