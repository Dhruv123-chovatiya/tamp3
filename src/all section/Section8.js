...
const Section8 = () => {
    return (
        <section style={{ backgroundColor: '#f2f2f2', position: 'relative', display: 'flex' }}>
            <Container>
                <Box sx={{ minHeight: '936px', flexDirection: 'column', justifyContent: 'center' }}>
                    <Box sx={{ marginTop: '60px', marginBottom: '60px' }}>
                        <Grid container>
                            <Grid item md={6}>
                                <Fade left delay={100}>
                                    <Box sx={{ border: '0px solid transparent', minHeight: '776px', backgroundImage: 'linear-gradient(#e13690, #f97e83)' }}>
                                        <Box sx={{ padding: '30px 40px', justifyContent: 'flex-start', display: 'flex', flexDirection: 'column' }}>
                                            ...
                                            <Box sx={{ margin: '45px 0 0' }}>
                                                <Box sx={{ minHeight: '425px' }}>
                                                    <Grid container>
                                                        <Grid item md={12}>
                                                            <Box sx={{ textAlign: 'left', border: 'solid', borderColor: 'white', borderLeftWidth: '0', borderBottomWidth: '0', borderRightWidth: '0', display: 'flex', position: 'relative' }}>
                            ...
                            <Grid item md={6}>
                                <Fade right delay={100}>
                                    <Box sx={{ border: '0px solid transparent', minHeight: '776px', backgroundColor: 'white', textAlign: 'left', flexDirection: 'column' }}>
